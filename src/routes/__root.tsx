...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Immo X Shock Tools" },
      { name: "description", content: "Immo X Shock Tools collection includes: Cookie Refresher, Bypasser" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Immo X Shock Tools" },
      { property: "og:description", content: "Immo X Shock Tools collection includes: Cookie Refresher, Bypasser" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Immo X Shock Tools" },
      { name: "twitter:description", content: "Immo X Shock Tools collection includes: Cookie Refresher, Bypasser" },
